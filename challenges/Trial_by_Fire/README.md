...
## Solution
1. A web chall. `snyk code test` gives us a possible SSTI in the template rendering in [routes.py](./web_trial_by_fire/challenge/application/blueprints/routes.py).
2. `<++>`
3. `./solve.sh`
